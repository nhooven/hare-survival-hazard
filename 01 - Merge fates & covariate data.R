...
fates <- read.csv("data_raw/fates_final.csv")

# landscape covariates
lsm <- read.csv("data_cleaned/lsm_demo.csv")
...
covs <- read.csv("data_raw/covariates_final.csv")
...
# here, we will use the survSplit function in the "survival" package to split 
# the dataset by week
...
write.csv(day.lookup, "data_cleaned/day_lookup.csv", row.names = F)
...
write.csv(fates.8, "data_cleaned/fates_final_cleaned.csv", row.names = F)
